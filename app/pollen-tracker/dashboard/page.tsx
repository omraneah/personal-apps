...
export default function DashboardPage() {
  ...
  useEffect(() => {
    const t = localStorage.getItem("pollen-tracker:atmo_token");
    if (!t) { router.replace("/pollen-tracker"); return; }
    setToken(t);
  }, [router]);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
        ...
        <button
          onClick={() => { localStorage.removeItem("pollen-tracker:atmo_token"); router.replace("/pollen-tracker"); }}
